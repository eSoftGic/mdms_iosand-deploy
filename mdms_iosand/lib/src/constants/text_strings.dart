...
const String tEmailLogin = "Login with Email";
const String tPhoneLogin = "Login with Phone";
...
const String tDevideId = "Device ID";
const String tForgetPassword = "Forget Password";
const String tSignInWithGoogle = "Sign-In with Google";

// -- Splash Screen Text
const String tAppName = "mDMS 2024";
String tAppTagLine = "Application for \nDistributors";

// -- On Boarding Text
const String tOnBoardingTitle1 = "Welcome"; //"Build Awesome Apps";
...
// -- Welcome Screen Text
const String tWelcomeTitle = "mDMS 2024";
const String tWelcomeSubTitle = "mobile Distribution Management System";

// -- Login Screen Text
const String tLoginTitle = "Welcome..";
const String tLoginSubTitleEmail = "Login";
const String tLoginSubTitlePhone = "Login with PhoneNo";
const String tRememberMe = "Remember Me?";
const String tDontHaveAnAccount = "Don't have an Account? ";

// -- Sign Up Screen Text
const String tSignUpTitle = "SignUp!";
const String tSignUpSubTitle = "Create your profile";
...
const String tDashboardTitle = "Home";
const String tDashboardHeading = "Dashboard";
...
const String tProfileHeading = "mDMS 2024";
const String tProfileSubHeading = "www.smgroupco.com";
// -- Menu
...
const String tJoinedAt = " 01st April 2023";